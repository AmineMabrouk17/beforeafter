...
if ($All -or $GlobalOnly) {
  ...
  Fetch "$RawBase/templates/flows.example.json" "$HermesSkill/templates/flows.example.json"
  Fetch "$RawBase/templates/preview-link.mjs" "$HermesSkill/templates/preview-link.mjs"
  Fetch "$RawBase/templates/auth-bypass-guard.mjs" "$HermesSkill/templates/auth-bypass-guard.mjs"
  ...
  Fetch "$RawBase/templates/flows.example.json" "$OpenGlobal/templates/flows.example.json"
  Fetch "$RawBase/templates/preview-link.mjs" "$OpenGlobal/templates/preview-link.mjs"
  Fetch "$RawBase/templates/auth-bypass-guard.mjs" "$OpenGlobal/templates/auth-bypass-guard.mjs"
